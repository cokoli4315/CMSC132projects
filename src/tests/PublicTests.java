...
public class PublicTests {
	...
	@Test
	public void testPossibleHands() {
	
		
		ArrayList<Card>list=new ArrayList<>();
		list.add(new Card(Rank.FIVE,Suit.SPADES));
		list.add(new Card(Rank.TWO,Suit.HEARTS));
		list.add(new Card(Rank.ACE,Suit.HEARTS));
		
		BlackjackModel.possibleHandValues(list);
	}
	@Test
	public void testAssessHand() {
		...
		list.add(new Card(Rank.ACE,Suit.HEARTS));
		BlackjackModel.assessHand(list);
		

		BlackjackModel game = new BlackjackModel();
		game.setDealerCards(list);
		assertTrue(game.dealerShouldTakeCard()==false);
